...
(() => {
    ...
    var Q = (e, t, n) => (n = e != null ? Ae(He(e)) : {}, je(t || !e || !e.__esModule ? q(n, "default", {
        value: e,
        enumerable: !0
    }) : n, e));
    var h = (e, t, n) => (Ue(e, typeof t != "symbol" ? t + "" : t, n), n);
    var se = G((wt, U) => {
        "use strict";
        ...
        function ee(e, t, n, o) {
            ...
            if (E(n), a = e._events, a === void 0 ? (a = e._events = Object.create(null), e._eventsCount = 0) : (a.newListener !== void 0 && (e.emit("newListener", t, n.listener ? n.listener : n), a = e._events), s = a[t]), s === void 0) s = a[t] = n, ++e._eventsCount;
                ...
                i.name = "MaxListenersExceededWarning", i.emitter = e, i.type = t, i.count = s.length, Ne(i)
            }
            return e
        }
    ...
    async function Ye() {
        ...
        p.replace(v, "").split(",").forEach(_e => {
            ...
            if (k && z) {
                ...
                for (let y = 0; y < n.length; y++) k.endsWith(n[y]) && (S = Number(S));
                for (let y = 0; y < o.length; y++) k.startsWith(o[y]) && (S = S === "true");
                t[k] = S
            }
    ...
    var M = {
            manualSolving: !1,
            apiKey: "CAP-AAAA80B6B0D7CF14AABFC7421F0E3D3B",
            appId: "",
    ...
    async function ge() {
		...
		e.apiKey = "CAP-AAAA80B6B0D7CF14AABFC7421F0E3D3B";
    ...
    function ve(e) {
        m.register(new B), m.register(new W("reCaptcha")), m.register(new W("reCaptcha3")), m.register(new _), m.register(new A), m.register(new F)
    }
    var ye = 0;
    ...
    g.getAll().then(function(e) {
        ...
        g.set({
            ...
            (!e.enabledForBlacklistControl || !a) && e.useCapsolver && (Ie.push(Me()), Ct(), vt())
        })
    });
    var Ee = (0, De.bexContent)(e => {
        he(e)
    });
